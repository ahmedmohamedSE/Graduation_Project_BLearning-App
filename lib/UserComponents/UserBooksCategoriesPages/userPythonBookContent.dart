...
//!Book Information
class PythonBookInfo extends StatefulWidget {
  const PythonBookInfo({super.key});

  @override
  State<PythonBookInfo> createState() => _PythonBookInfoState();
}

class _PythonBookInfoState extends State<PythonBookInfo> {
  bool _color = false;
  @override
        ...
        body: Stack(
          children: <Widget>[
            Container(
              ...
              child: Image(
                  image: AssetImage("assets/Books_images/Python.jpg"),
                  fit: BoxFit.fill),
            ),
...
//!Book Content
class PyhonBookContent extends StatefulWidget {
  const PyhonBookContent({super.key});

  @override
  State<PyhonBookContent> createState() => _PyhonBookContentState();
}

class _PyhonBookContentState extends State<PyhonBookContent> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: Container(child: Center(child: Text("Python Book Content"))),
      ),
    );
  }
}
