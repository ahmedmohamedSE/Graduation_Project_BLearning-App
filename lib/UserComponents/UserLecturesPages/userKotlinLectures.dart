...
class KotlinCourseALLLectures extends StatefulWidget {
  const KotlinCourseALLLectures({super.key});

  @override
  State<KotlinCourseALLLectures> createState() =>
      _KotlinCourseALLLecturesState();
}

class _KotlinCourseALLLecturesState extends State<KotlinCourseALLLectures>
          ...
          children: [
            ListView(
              ...
              children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: AssetImage(
                                "assets/courses_icons/kotlin.png"),
                            fit: BoxFit.fill,
                          ),
                        ),
                      ),
                ...
                SizedBox(height: _w / 13),
                cards("Lecture 1", "Kotlin Installation"),
                cards("Lecture 2", "Kotlin Introduction"),
                cards("Lecture 3", "Kotlin Applications"),
                cards("Lecture 4", "Kotlin Variables"),
                cards("Lecture 5", "Kotlin Data Types"),
                cards("Lecture 6", "Kotlin All Operators"),
                cards("Lecture 7", "Kotlin Comments"),
                cards("Lecture 8", "Kotlin If else"),
                cards("Lecture 9", "Kotlin Loops"),
                cards("Lecture 10", "Kotlin Break & Continue"),
                cards("Lecture 11", "Kotlin String Functions"),
                cards("Lecture 12", "Kotlin List & Tuple"),
                cards("Lecture 13", "Kotlin Maps & Sets & Dictionary"),
                cards("Lecture 14", "Kotlin Functions"),
                cards("Lecture 15", "Kotlin Function Perimeters"),
                cards("Lecture 16", "Kotlin OOP"),
                cards("Lecture 17", "Kotlin Data Structure"),
                cards("Lecture 18", "Kotlin Databases"),
                cards("Lecture 19", "Kotlin The best problem solvings"),
                cards("Lecture 20", "Kotlin Algorithms"),
              ],
            ),
