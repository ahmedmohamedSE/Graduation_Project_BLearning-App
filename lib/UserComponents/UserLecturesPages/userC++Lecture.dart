...
class CplusCourseALLLectures extends StatefulWidget {
  const CplusCourseALLLectures({super.key});

  @override
  State<CplusCourseALLLectures> createState() =>
      _CplusCourseALLLecturesState();
}

class _CplusCourseALLLecturesState extends State<CplusCourseALLLectures>
          ...
          children: [
            ListView(
              ...
              children: [
                ...
                SizedBox(height: _w / 13),
                cards("Lecture 1", "C++ Installation"),
                cards("Lecture 2", "C++ Introduction"),
                cards("Lecture 3", "C++ Applications"),
                cards("Lecture 4", "C++ Variables"),
                cards("Lecture 5", "C++ Data Types"),
                cards("Lecture 6", "C++ All Operators"),
                cards("Lecture 7", "C++ Comments"),
                cards("Lecture 8", "C++ If else"),
                cards("Lecture 9", "C++ Loops"),
                cards("Lecture 10", "C++ Break & Continue"),
                cards("Lecture 11", "C++ String Functions"),
                cards("Lecture 12", "C++ List & Tuple"),
                cards("Lecture 13", "C++ Maps & Sets & Dictionary"),
                cards("Lecture 14", "C++ Functions"),
                cards("Lecture 15", "C++ Function Perimeters"),
                cards("Lecture 16", "C++ OOP"),
                cards("Lecture 17", "C++ Data Structure"),
                cards("Lecture 18", "C++ Databases"),
                cards("Lecture 19", "C++ The best problem solvings"),
                cards("Lecture 20", "C++ Algorithms"),
              ],
            ),
